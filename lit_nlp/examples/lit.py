...
class CaseOutcomePredictionModel(lit_model.Model):
  """Brazil lower court case outcome description."""

  # LABELS = [0, 1, 2]  # {2: "Denied", 1: "Granted", 0: "Partial"}
  LABELS = [0, 1]
  def __init__(self, model_name_or_path):
    self.max_seq_len = 1024
    self.tokenizer = transformers.LongformerTokenizerFast.from_pretrained(
        "/Users/ramyavunikili/DeJURE/Brazil/Models/Longformer/longformer-pt-v1-wiki",
        max_length=self.max_seq_len)
    ##ToDo
    model_config = transformers.AutoConfig.from_pretrained("/Users/ramyavunikili/DeJURE/Brazil/Models/Output/Longformer/v5-wiki-cumulative-v2/results/best_model", num_labels=len(self.LABELS),
    ...
    #     model_name_or_path,
    #     config=model_config)
    self.model = transformers.LongformerForSequenceClassification.from_pretrained("/Users/ramyavunikili/DeJURE/Brazil/Models/Output/Longformer/v5-wiki-cumulative-v2/results/best_model", config=model_config)
    self.model.eval()
  ...
  def predict_minibatch(self, inputs):
    ...
    # encoded_input = self.tokenizer(input['Content'].values,  padding = 'max_length',
...
def main(_):
  ...
  models = {"PCBT": CaseOutcomePredictionModel(model_path)}
  # Load SST-2 validation set from TFDS.
  #datasets = {"sst_dev": glue.SST2Data("validation")}
  datasets = {"Brazil_lower_court":glue.DJDataset("validation")}
...
if __name__ == "__main__":
  app.run(main)
  ## Commands:
  # python -m lit --port=5432 --model_path="/Users/ramyavunikili/DeJURE/Brazil/Models/Output/Longformer/v5-wiki-cumulative-v2/results/best_model"